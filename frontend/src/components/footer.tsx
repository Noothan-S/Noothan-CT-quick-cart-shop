                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <p className="text-gray-400">
                            Connecting global vendors with customers worldwide. Discover unique products and support independent sellers.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/vendor-signup" className="text-gray-400 hover:text-white">Become a Seller</Link></li>
                            <li><Link to="/vendor-login" className="text-gray-400 hover:text-white">Vendor Login</Link></li>
                            <li><Link to="/vendor-faq" className="text-gray-400 hover:text-white">Vendor FAQ</Link></li>
                        </ul>
                    </div>
                    <div>
