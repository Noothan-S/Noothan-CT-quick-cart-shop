...
const createProductValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        discount: zod_1.z.number().min(0, "Discount cannot be negative").max(100, "Discount cannot exceed 100%"),
...
const updateProductValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        imgs: zod_1.z.array(zod_1.z.string().min(1, "Image filename cannot be empty")).optional(),
        ...
        quantity: zod_1.z.number().int().nonnegative("Quantity cannot be negative").optional(),
    })
});
